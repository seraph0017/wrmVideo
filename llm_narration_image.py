...
def regenerate_failed_image(image_path: str) -> bool:
    ...
    try:
        ...
        # 构建生成提示词，强调领口和手部要求
        regenerate_prompt = "基于原图进行改进，一个古代中国女性角色，穿着传统服装，必须是圆领、立领或高领，绝对不能是V领、交领、衽领、y字型领或其他露出脖子以下皮肤的领型，角色只能有两只手，不能有三只手或更多手臂，画面清晰，细节丰富，宫崎骏动漫风格"
