...
# -*- coding: utf-8 -*-
"""
gen_script.py - 增强版脚本生成器 (20251124v1)

基于gen_script_v2.py的增强版本，适配video_scripts/20251124v1目录结构。
新增功能：
1. 自动章节质量验证
2. 不达标章节自动重新生成
3. 支持指定生成前N个章节
...
使用方法:
    python video_scripts/20251124v1/gen_script.py data/031/酒店门缝.txt --output data/031/chapter_xxx
"""
...
# video_scripts/20251124v1 -> video_scripts -> wrmVideo (root)
